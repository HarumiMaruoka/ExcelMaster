...
{
    internal class CsvObjectMapper
    {
        ...
        /// <summary>
        /// 新しい推奨メソッド:2次元配列のCSVデータ(行0:プロパティ名, 行1:型情報)からオブジェクト配列にマッピングします。
        /// </summary>
        /// <typeparam name="T">生成対象型</typeparam>
        /// <param name="csv">CSVセル値0,1行目はヘッダー</param>
        /// <returns>T の配列</returns>
        public T[] MapCsvToObjects<T>(string[,] csv) where T : new()
        {
        ...
        /// </summary>
        private object ConvertCell(string raw, Type targetType)
        {
